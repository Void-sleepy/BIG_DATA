...
RUN pip3 install --no-cache-dir \
    kafka-python confluent-kafka requests pandas beautifulsoup4 \
    pyspark==3.3.0 cassandra-driver python-dotenv playwright lxml selenium aiohttp python-dateutil
...
RUN chown -R 1001:1001 /app && chown -R 1001:1001 /tmp/checkpoint && chmod +x /app/*.py
